...
//
// pll_clk is then used to generate lower frequencies throught divisors:
...
const MipiRegister MIPI_REGISTERS[] = {
	...
	{REG_FiFoCtl, 0x64},
	{REG_DataFmt,(PDFormat_RAW8 << DataFmt_PDFormat) | (1 << DataFmt_UDT_en)},	// Output 8 bits RAW image
